...
Class User implements Crud, Authenticator{
    ...
    function __construct($first_name, $last_name, $city_name, $email, $phone, $username, $password, $profile_picture, $utc_timestamp, $offset){
    ...
    public function save(){
        ...
        try{
            ...
            $stmt = null;
                ...
                echo"Error to save to database";
        }
    ...
    public function isPasswordCorrect(){
        ...
        $res = mysqli_query($DBCon->conn, "SELECT * FROM users")  or die("Error ".mysqli_error($con->conn));
